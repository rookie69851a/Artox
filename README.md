...
local Window = OrionLib:MakeWindow({Name = "ARTOX XCTR HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "ARTOX XCTR HUB"})
...
W:AddLabel("[+] ARTOX XCTR HUB is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "ARTOX XCTR HUB(Noitification)",
